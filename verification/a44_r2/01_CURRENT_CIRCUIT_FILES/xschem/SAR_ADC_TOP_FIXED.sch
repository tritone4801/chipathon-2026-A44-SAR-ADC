...
G {}
K {type=subcircuit
format="@name @pinlist SAR_ADC_TOP_FIXED"
template="name=XTOP"}
V {}
S {}
F {}
...
N 630 -290 670 -290 {lab=CLKS}
N 630 30 670 30 {lab=CLKS}
...
C {iopin.sym} 200 130 0 0 {name=p2 lab=GND}
C {iopin.sym} 280 100 0 0 {name=p3 lab=VREFP}
C {iopin.sym} 280 130 0 0 {name=p4 lab=VREFN}
C {ipin.sym} 260 -80 0 0 {name=p5 lab=CLKS}
C {ipin.sym} 260 -10 0 0 {name=p7 lab=VINP}
C {ipin.sym} 260 20 0 0 {name=p8 lab=VINN}
C {opin.sym} 330 -50 0 0 {name=p9 lab=DOUT[7:0]}
C {A44_Comparator_StrongARM.sym} 1240 -120 0 0 {name=x1
schematic=Comparator_StrongARM.sch}
C {A44_CDAC.sym} 820 -270 0 0 {name=x2
schematic=CDAC.sch}
C {A44_CDAC.sym} 820 10 2 1 {name=x3
schematic=CDAC.sch}
...
C {lab_wire.sym} 660 -290 0 0 {name=p11 sig_type=std_logic lab=CLKS}
C {lab_wire.sym} 660 30 0 0 {name=p12 sig_type=std_logic lab=CLKS}
...
C {lab_wire.sym} 1470 -170 0 0 {name=p24 sig_type=std_logic lab=CLKS}
