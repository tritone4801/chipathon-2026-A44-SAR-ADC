...
LAYOUT_FILE = gds/A44_SAR_ADC_CORE_1000_R3_DUMMY_FILL_REPAIR.gds
```

## Published layout names

All public filenames use the `A44_SAR_ADC_` prefix. GDS top-cell names remain
unchanged so that hierarchy and existing integration contracts are preserved.

| Role | Public filename stem | GDS top cell | Size (um) |
| --- | --- | --- | ---: |
| CORE | `A44_SAR_ADC_CORE_1000_R3_DUMMY_FILL_REPAIR` | `A44_SAR_ADC_CORE_1000_R3_DUMMY_FILL_REPAIR` | 1000 x 1000 |
| CDAC east | `A44_SAR_ADC_CDAC_E_R7` | `A44_CDAC_UNIT_E_R7` | 390 x 626 |
| CDAC west | `A44_SAR_ADC_CDAC_W_R7` | `A44_CDAC_UNIT_W_R7` | 390 x 626 |
| Comparator | `A44_SAR_ADC_COMPARATOR_R9` | `A44_COMP_PEX_ECO1_SD_REQUIRED_G6_FULL_R9` | 168 x 100 |
| SAR logic | `A44_SAR_ADC_SAR_LOGIC_R1L` | `SAR_LOGIC_ACTUAL_RTL_SS` | 240 x 240 |
| Clock buffer | `A44_SAR_ADC_CLKS_BUFFER_R1` | `A44_CLKS_BUFFER_R1` | 120 x 60 |
